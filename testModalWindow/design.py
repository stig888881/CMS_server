...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:/PycharmProjects (2)/TestGu/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon2)
        self.pushButton.setIconSize(QtCore.QSize(90, 80))
        self.pushButton.setObjectName("pushButton")
        self.buttonGroup.addButton(self.pushButton)
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(20, 150, 631, 291))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(300, 30, 75, 23))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(290, 70, 101, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "CP Vendor Name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "CP Vendor Model"))
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Remote"))
        self.pushButton_4.setText(_translate("MainWindow", "ModalWindow"))
